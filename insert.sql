...
-- Utilise des sous-requêtes pour trouver automatiquement les IDs par email
INSERT INTO cms (element, english_content, french_content, illustration, user_id, is_active, start_date, end_date, components)
SELECT 'hero_title', 'Welcome to Mars AI Film Festival 2026', 'Bienvenue au Festival Mars AI 2026', 'hero_bg.jpg', id, 0, NULL, NULL, NULL FROM user WHERE email = 'superadmin@marsai.com'
UNION ALL SELECT 'hero_subtitle', 'Where Artificial Intelligence Meets Cinematic Art', 'Où l''Intelligence Artificielle Rencontre l''Art Cinématographique', NULL, id, 0, NULL, NULL, NULL FROM user WHERE email = 'superadmin@marsai.com'
UNION ALL SELECT 'about_section', 'Mars AI is the first international film festival dedicated to AI-generated cinema. We celebrate creativity, innovation, and the future of storytelling. This year features 25 exceptional films from 20 countries.', 'Mars AI est le premier festival international de cinéma dédié aux films générés par IA. Nous célébrons la créativité, l''innovation et l''avenir de la narration. Cette année présente 25 films exceptionnels de 20 pays.', 'about_image.jpg', id, 0, NULL, NULL, NULL FROM user WHERE email = 'superadmin@marsai.com'
UNION ALL SELECT 'submission_rules', 'Films must be at least 50% AI-generated. Maximum duration: 20 minutes. All genres accepted. Deadline: February 15, 2026.', 'Les films doivent être au moins 50% générés par IA. Durée maximale : 20 minutes. Tous genres acceptés. Date limite : 15 février 2026.', NULL, id, 0, NULL, NULL, NULL FROM user WHERE email = 'admin@marsai.com'
UNION ALL SELECT 'jury_section', 'Our prestigious jury includes award-winning directors and AI pioneers who will select this year''s winners.', 'Notre prestigieux jury comprend des réalisateurs primés et des pionniers de l''IA qui sélectionneront les gagnants de cette année.', 'jury_section.jpg', id, 0, NULL, NULL, NULL FROM user WHERE email = 'superadmin@marsai.com'
UNION ALL SELECT 'awards_section', 'Eight awards will be presented including Grand Prix, Public Choice, and Innovation prizes.', 'Huit prix seront remis dont le Grand Prix, le Prix du Public et les prix de l''Innovation.', 'awards_section.jpg', id, 0, NULL, NULL, NULL FROM user WHERE email = 'superadmin@marsai.com'
UNION ALL SELECT 'contact_info', 'Email: contact@marsai-festival.com | Phone: +33 1 23 45 67 89 | Address: 1 Rue du Festival, 75001 Paris', 'Email : contact@marsai-festival.com | Téléphone : +33 1 23 45 67 89 | Adresse : 1 Rue du Festival, 75001 Paris', NULL, id, 0, NULL, NULL, NULL FROM user WHERE email = 'admin@marsai.com'
